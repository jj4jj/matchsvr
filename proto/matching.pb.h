...
class MatchedResult : public ::google::protobuf::Message {
 public:
  ...
  inline ::google::protobuf::uint32 teams(int index) const;
  inline void set_teams(int index, ::google::protobuf::uint32 value);
  inline void add_teams(::google::protobuf::uint32 value);
 ...
 private:
  ...
  ::google::protobuf::RepeatedField< ::google::protobuf::uint32 > teams_;
...
inline ::google::protobuf::uint32 MatchedResult::teams(int index) const {
  return teams_.Get(index);
}
inline void MatchedResult::set_teams(int index, ::google::protobuf::uint32 value) {
  teams_.Set(index, value);
}
inline void MatchedResult::add_teams(::google::protobuf::uint32 value) {
  teams_.Add(value);
}
inline const ::google::protobuf::RepeatedField< ::google::protobuf::uint32 >&
